...
/*
      ...
      */
        ...
        What is the difference between abstract classes and concrete classes?
           ...
           First difference abstract class can not give object but concrete classes can give.
           Second difference Abstract classes can have abstract methods and concrete methods
           but concrete classes can only have concrete methods.

           If we put abstract method in concrete class It will give error.
         */

          // Final methods, Private methods, Static methods can not be abstract.
          // If a method is final it should have a body, If its private it should have a body
          // If a method is static it should have a body.
