...
public class C03Exceptions {
    public static void main(String[] args) {
        ...
        System.out.println(getCharConvertToInt("My Java",3));//NumberFormatException: Java throws NumberFormatException
                                                                    //if you use non-digit character in parseInt() method
    ...
    //3.Way to handle multiple Exceptions use a specific implementation for a specific Exception and useException class for al the others
    public static int getCharConvertInt(String s, int idx){
        ...
        try{
            ...
            System.out.println("Specific implementation for NumberFormatExceptions");
        }catch(Exception e){
            System.out.println(e.getMessage());
        }
        return result;
